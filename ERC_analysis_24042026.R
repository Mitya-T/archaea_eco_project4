...
setwd('/home/dimitri/project4/ERC/alcaliphiles/')
root_dir <- "."
...
# --- Name map ---
name_map <- c(
  "GCF_000828915.1" = "Serpentinomonas sp B1",
  "GCF_000026045.1" = "Natronomonas pharaonis",
  "GCA_019593585.1" = "Nitzschia palea"
)
...
print(results_table)
write_csv(results_table, "alcaliphiles_G4_summary.csv")
...
setwd('/home/dimitri/project4/ERC/halophiles/')
root_dir <- "."
...
# --- Name map ---
name_map <- c(
  "GCF_000025685.1" = "Haloferax volcanii",
  "GCF_900103135.1" = "Halarsenatibacter silvermanii",
  "GCF_000013045.1" = "Salinibacter ruber M31T",
  "GCF_000371785.1" = "Actinopolyspora halophila",
  "GCA_037044905.1" = "Hortaea werneckii",
  "GCA_002284615.2" = "Dunaliella salina",
  "GCF_032884065.1" = "Artemia franciscana"
)
...
print(results_table)
write_csv(results_table, "halophiles_G4_summary.csv")
...
setwd('/home/dimitri/project4/ERC/piezophiles/')
root_dir <- "."
...
# --- Name map ---
name_map <- c(
  "GCF_001444365.1" = "Colwellia sp MT41",
  "GCF_000215995.1" = "Pyrococcus yayanosii",
  "GCF_001647085.1" = "Thermococcus piezophilus",
  "GCF_000372725.1" = "Globoquadrina spp (protist) – Emiliana huxleyi"
...
setwd('/home/dimitri/project4/ERC/polyextremophiles/')
root_dir <- "."
...
# --- Name map ---
name_map <- c(
  "GCF_022341425.1" = "Halomonas campisalis",
  "GCF_000020485.1" = "Halothermothrix orenii",
  "GCF_000341285.1" = "Galdieria sulphuraria",
  "GCF_000026045.1" = "Natronomonas pharaonis"
)
...
print(results_table)
write_csv(results_table, "polyextremophiles_G4_summary.csv")
